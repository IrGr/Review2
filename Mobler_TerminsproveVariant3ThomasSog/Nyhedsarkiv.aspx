<%@ Page Title="Nyhedsarkiv: CMK Møbler" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Nyhedsarkiv.aspx.cs" Inherits="Nyhedsarkiv" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>

<asp:Content ID="Content_SideNavn" ContentPlaceHolderID="ContentPlaceHolder_SideNavn" runat="server">
     <asp:Label ID="Label_SideNavn" runat="server" Text="Nyhedsarkiv"></asp:Label>
</asp:Content>
